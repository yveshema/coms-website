...
import comparison from '../images/Illustrations/desktop/about/Moringa-comparison-to-other-foods-illustration.svg'
import comparisonMobile from '../images/Illustrations/mobile/about/100-grams-of-moringa-mobile.svg'
import nutrition from '../images/Illustrations/desktop/about/Moringa-opportunities.svg'
import nutritionMobile from '../images/Illustrations/mobile/about/moringa-opportunities-mobile.svg'
import opportunity from '../images/Illustrations/desktop/about/Moringa-infographics.svg'
import opportunityMobile from '../images/Illustrations/mobile/about/uses-of-moringa-mobile.svg'

<SEO title="about" keywords={['moringa', 'organic', 'standard']} />

<h1 class="about-para">Nutritional Value and <br/>Benefits of Moringa</h1>
...
<h1 class="parafont about-para1"> Moringa Comparison With Other<br/> Types of Foods</h1>
