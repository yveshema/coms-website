...
**Fertilization must be done during land preparation, before seeding**. After it is important to apply manure or compost at least once a year, for instance before the rainy season, when the trees are about to start an intense growth period (pruning can also be done at this time). If there are two rainy seasons, two applications are advised.
