...
<blockquote>
<ul class="line-high">
   <li>Crops that require a lot of nitrogen, such as maize or cassava;</li>
   <li> Crops that require chemical treatments;</li>
   <li>Crops that can compete for light with moringa trees millet, sorghum). It is better to 
associate crops that can enrich the soil in minerals, especially in nitrogen like leguminous plants such as groundnut, soy or beans.</li>
</ul>
</blockquote>
