...
The use of a solar dryer is recommended but the polyethylene used should be UV treated or opaque (if the plastic is black, beware of temperature increases and be 
