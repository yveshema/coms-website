...
<figure>
<picture>
    <source media="(min-width: 767px)" srcset={images.desktop.hygiene} alt="personal hygiene"/>
...
<figure>
<picture>
    <source media="(min-width: 767px)" srcset={images.desktop.packaging} alt="bulk Packaging"/>
