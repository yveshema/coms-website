...
title: processing
excerpt: "Processing should start immediately after harvesting and transporting  the leaves to the processing point"
---
...
import labelingMobile from '../images/Illustrations/mobile/transportation/labeling.svg';
import bulkPackagingMobile from '../images/Illustrations/mobile/transportation/bulk-packaging.svg';
import personalHygieneMobile from '../images/Illustrations/mobile/transportation/personal-hygiene.svg';
import roomDryingMobile from '../images/Illustrations/mobile/transportation/room-drying.svg';
import strainingMobile from '../images/Illustrations/mobile/transportation/moringa-straining.svg';
import moringaPetioleMobile from '../images/Illustrations/mobile/transportation/moringa-petiole.svg';
...
<figure>
<picture>
    <source media="(min-width: 767px)" srcset={moringaPetiole} alt="moringa petiole"/>
    <img src={moringaPetioleMobile} alt="moringa petiole" />
</picture>
</figure>
...
<figure>
<picture>
    <source media="(min-width: 767px)" srcset={straining} alt="draining"/>
    <img src={strainingMobile} alt="draining" />
</picture>
</figure>
...
<figure>
<picture>
    <source media="(min-width: 767px)" srcset={roomDrying} alt="room drying"/>
    <img src={roomDryingMobile} alt="room drying" />
</picture>
</figure>
...
<figure>
<picture>
    <source media="(min-width: 767px)" srcset={personalHygiene} alt="personal hygiene"/>
    <img src={personalHygieneMobile} alt="personal hygiene" />
</picture>
</figure>
...
<figure>
<picture>
    <source media="(min-width: 767px)" srcset={bulkPackaging} alt="bulk Packaging"/>
    <img src={bulkPackagingMobile} alt="bulk packaging" />
</picture>
</figure>
...
<p class="captionName">Each package of moringa leaf product must be legibly marked
with the following information:</p>
<blockquote>
<ol className="listLine">
...
<figure>
<picture>
    <source media="(min-width: 767px)" srcset={labeling} alt="labeling"/>
    <img src={labelingMobile} alt="labeling" />
</picture>
</figure>
