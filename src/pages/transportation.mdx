---
title:  "Transportation in moringa leaf production is a very critical step in ensuring high quality leaves for consumption."
---
...
import moringaBranch from '../images/Illustrations/desktop/transportation/moringa-branch.svg';

<SEO title="about" keywords={['moringa', 'organic', 'standard','safety','transparency','sustainability','scalability', 'transportation','quality','consumption']} />
...
<figure>
    <img src={moringaBranch} alt="moringa branch" />
</figure>
...
Transportation should be during the cooler parts of theday: early morning, evening or night.
