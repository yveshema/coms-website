...
import moringaBranchMobile from '../images/Illustrations/mobile/transportation/moringa-branch.svg';
...
<figure>
<picture>
    <source media="(min-width: 767px)" srcset={moringaBranch} alt="moringa branch"/>
    <img src={moringaBranchMobile} alt="moringa branch" />
</picture>
</figure>
